...
int _sdkCoreThreadingTaskhandlecancelStatic(int _token, Pointer<Uint8> _result) {
  bool _resultObject;
  try {
    _resultObject = (__lib.instanceCache[_token] as TaskHandle).cancel();
...
int _sdkCoreThreadingTaskhandleisFinishedGetStatic(int _token, Pointer<Uint8> _result) {
  _result.value = booleanToFfi((__lib.instanceCache[_token] as TaskHandle).isFinished);
  return 0;
}
int _sdkCoreThreadingTaskhandleisCancelledGetStatic(int _token, Pointer<Uint8> _result) {
  _result.value = booleanToFfi((__lib.instanceCache[_token] as TaskHandle).isCancelled);
  return 0;
}
...
Pointer<Void> sdkCoreThreadingTaskhandleToFfi(TaskHandle value) {
  ...
  final result = _sdkCoreThreadingTaskhandleCreateProxy(
    ...
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Uint8>)>(_sdkCoreThreadingTaskhandlecancelStatic, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Uint8>)>(_sdkCoreThreadingTaskhandleisFinishedGetStatic, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Uint8>)>(_sdkCoreThreadingTaskhandleisCancelledGetStatic, __lib.unknownError)
  );
