...
class AddressQuery {
  ...
  static AddressQuery _withAreaCenterInCountries(String query, GeoCoordinates areaCenter, List<CountryCode> countries) {
    final _withAreaCenterInCountriesFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>), Pointer<Void> Function(int, Pointer<Void>, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_search_AddressQuery_make__String_GeoCoordinates_ListOf_1sdk_1core_1CountryCode'));
    final _queryHandle = stringToFfi(query);
    final _areaCenterHandle = sdkCoreGeocoordinatesToFfi(areaCenter);
