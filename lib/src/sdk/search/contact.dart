...
final _sdkSearchContactGetFieldlandlinePhoneNumbers = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Contact_get_field_landlinePhoneNumbers'));
final _sdkSearchContactGetFieldmobilePhoneNumbers = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Contact_get_field_mobilePhoneNumbers'));
final _sdkSearchContactGetFieldemailAddresses = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Contact_get_field_emailAddresses'));
final _sdkSearchContactGetFieldwebsiteAddresses = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
...
Pointer<Void> sdkSearchContactToFfi(Contact value) {
  final _landlinePhoneNumbersHandle = heresdkSearchCommonBindingsListofStringToFfi(value.landlinePhoneNumbers);
  final _mobilePhoneNumbersHandle = heresdkSearchCommonBindingsListofStringToFfi(value.mobilePhoneNumbers);
  final _emailAddressesHandle = heresdkSearchCommonBindingsListofStringToFfi(value.emailAddresses);
  final _websiteAddressesHandle = heresdkSearchCommonBindingsListofStringToFfi(value.websiteAddresses);
  ...
  final _result = _sdkSearchContactCreateHandle(_landlinePhoneNumbersHandle, _mobilePhoneNumbersHandle, _emailAddressesHandle, _websiteAddressesHandle, _landlinePhonesHandle, _mobilePhonesHandle, _emailsHandle, _websitesHandle);
  heresdkSearchCommonBindingsListofStringReleaseFfiHandle(_landlinePhoneNumbersHandle);
  heresdkSearchCommonBindingsListofStringReleaseFfiHandle(_mobilePhoneNumbersHandle);
  heresdkSearchCommonBindingsListofStringReleaseFfiHandle(_emailAddressesHandle);
  heresdkSearchCommonBindingsListofStringReleaseFfiHandle(_websiteAddressesHandle);
...
Contact sdkSearchContactFromFfi(Pointer<Void> handle) {
  final _landlinePhoneNumbersHandle = _sdkSearchContactGetFieldlandlinePhoneNumbers(handle);
  final _mobilePhoneNumbersHandle = _sdkSearchContactGetFieldmobilePhoneNumbers(handle);
  final _emailAddressesHandle = _sdkSearchContactGetFieldemailAddresses(handle);
  final _websiteAddressesHandle = _sdkSearchContactGetFieldwebsiteAddresses(handle);
  ...
  try {
    return Contact(
      heresdkSearchCommonBindingsListofStringFromFfi(_landlinePhoneNumbersHandle), 
      heresdkSearchCommonBindingsListofStringFromFfi(_mobilePhoneNumbersHandle), 
      heresdkSearchCommonBindingsListofStringFromFfi(_emailAddressesHandle), 
      heresdkSearchCommonBindingsListofStringFromFfi(_websiteAddressesHandle), 
