...
class PlaceIdSearchCallback$Impl {
  ...
  void release() => _sdkSearchPlaceidsearchcallbackReleaseHandle(handle);

  call(SearchError p0, Place p1) {
    final _callFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_search_PlaceIdSearchCallback_call__SearchError_Place'));
...
int _sdkSearchPlaceidsearchcallbackcallStatic(int _token, Pointer<Void> p0, Pointer<Void> p1) {
  
  try {
    (__lib.instanceCache[_token] as PlaceIdSearchCallback)(sdkSearchSearcherrorFromFfiNullable(p0)!, sdkSearchPlaceFromFfiNullable(p1)!);
  } finally {
...
Pointer<Void> sdkSearchPlaceidsearchcallbackToFfi(PlaceIdSearchCallback value) {
  final result = _sdkSearchPlaceidsearchcallbackCreateProxy(
    __lib.cacheObject(value),
    __lib.LibraryContext.isolateId,
    __lib.uncacheObjectFfi,
    Pointer.fromFunction<Int64 Function(Uint64, Pointer<Void>, Pointer<Void>)>(_sdkSearchPlaceidsearchcallbackcallStatic, __lib.unknownError)
  );
...
PlaceIdSearchCallback sdkSearchPlaceidsearchcallbackFromFfi(Pointer<Void> handle) {
  final _impl = PlaceIdSearchCallback$Impl(_sdkSearchPlaceidsearchcallbackCopyHandle(handle));
