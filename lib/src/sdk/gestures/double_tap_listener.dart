...
class DoubleTapListener$Impl extends __lib.NativeBase implements DoubleTapListener {
  ...
  onDoubleTap(Point2D origin) {
    ...
    final __resultHandle = _onDoubleTapFfi(_handle, __lib.LibraryContext.isolateId, _originHandle);
...
int _sdkGesturesDoubletaplisteneronDoubleTapStatic(int _token, Pointer<Void> origin) {

  try {
    (__lib.instanceCache[_token] as DoubleTapListener).onDoubleTap(sdkCorePoint2dFromFfi(origin));
  } finally {
...
Pointer<Void> sdkGesturesDoubletaplistenerToFfi(DoubleTapListener value) {
  ...
  final result = _sdkGesturesDoubletaplistenerCreateProxy(
    ...
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Void>)>(_sdkGesturesDoubletaplisteneronDoubleTapStatic, __lib.unknownError)
  );
