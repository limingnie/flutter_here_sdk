...
int _sdkMapviewMapviewlifecyclelisteneronAttachStatic(int _token, Pointer<Void> mapView) {

  try {
    (__lib.instanceCache[_token] as MapViewLifecycleListener).onAttach(sdkMapviewMapviewbaseFromFfi(mapView));
  } finally {
    sdkMapviewMapviewbaseReleaseFfiHandle(mapView);
  }
  return 0;
}
int _sdkMapviewMapviewlifecyclelisteneronDetachStatic(int _token, Pointer<Void> mapView) {

  try {
    (__lib.instanceCache[_token] as MapViewLifecycleListener).onDetach(sdkMapviewMapviewbaseFromFfi(mapView));
  } finally {
    sdkMapviewMapviewbaseReleaseFfiHandle(mapView);
  }
  return 0;
}
int _sdkMapviewMapviewlifecyclelisteneronPauseStatic(int _token) {
...
int _sdkMapviewMapviewlifecyclelisteneronResumeStatic(int _token) {
...
int _sdkMapviewMapviewlifecyclelisteneronDestroyStatic(int _token) {
...
Pointer<Void> sdkMapviewMapviewlifecyclelistenerToFfi(MapViewLifecycleListener value) {
  ...
  final result = _sdkMapviewMapviewlifecyclelistenerCreateProxy(
    ...
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Void>)>(_sdkMapviewMapviewlifecyclelisteneronAttachStatic, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Void>)>(_sdkMapviewMapviewlifecyclelisteneronDetachStatic, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Uint64)>(_sdkMapviewMapviewlifecyclelisteneronPauseStatic, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Uint64)>(_sdkMapviewMapviewlifecyclelisteneronResumeStatic, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Uint64)>(_sdkMapviewMapviewlifecyclelisteneronDestroyStatic, __lib.unknownError)
  );
