...
class IsolineOptionsCalculation {
  ...
  static IsolineOptionsCalculation _$init(IsolineRangeType rangeType, List<int> rangeValues, IsolineCalculationMode isolineCalculationMode, int maxPoints) {
    ...
    final __resultHandle = _$initFfi(__lib.LibraryContext.isolateId, _rangeTypeHandle, _rangeValuesHandle, _isolineCalculationModeHandle, _maxPointsHandle);
  ...
  static IsolineOptionsCalculation _withDefaults(IsolineRangeType rangeType, List<int> rangeValues) {
    final _withDefaultsFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Uint32, Pointer<Void>), Pointer<Void> Function(int, int, Pointer<Void>)>('here_sdk_sdk_routing_IsolineOptions_Calculation_make__IsolineRangeType_ListOf_1Int'));
    final _rangeTypeHandle = sdkRoutingIsolinerangetypeToFfi(rangeType);
    final _rangeValuesHandle = heresdkRoutingIsolineBindingsListofIntToFfi(rangeValues);
  ...
  static IsolineOptionsCalculation _withDefaultsAndDirection(IsolineRangeType rangeType, List<int> rangeValues, RoutePlaceDirection isolineDirection) {
    final _withDefaultsAndDirectionFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Int32, Uint32, Pointer<Void>, Uint32), Pointer<Void> Function(int, int, Pointer<Void>, int)>('here_sdk_sdk_routing_IsolineOptions_Calculation_make__IsolineRangeType_ListOf_1Int_RoutePlaceDirection'));
    final _rangeTypeHandle = sdkRoutingIsolinerangetypeToFfi(rangeType);
    final _rangeValuesHandle = heresdkRoutingIsolineBindingsListofIntToFfi(rangeValues);
