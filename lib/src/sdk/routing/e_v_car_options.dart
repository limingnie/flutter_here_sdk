...
class EVCarOptions {
  ...
  /// [RouteOptions.alternatives] = 0, [RouteOptions.speedCapInMetersPerSecond]
  /// is not set, and [AvoidanceOptions] is empty. Otherwise, this object
...
Pointer<Void> sdkRoutingEvcaroptionsToFfi(EVCarOptions value) {
  ...
  final _result = _sdkRoutingEvcaroptionsCreateHandle(_routeOptionsHandle, _textOptionsHandle, _avoidanceOptionsHandle, _ensureReachabilityHandle, _consumptionModelHandle, _batterySpecificationsHandle);
