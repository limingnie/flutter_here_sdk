...
class CalculateRouteCallback$Impl {
  ...
  void release() => _sdkRoutingCalculateroutecallbackReleaseHandle(handle);

  call(RoutingError p0, List<Route> p1) {
    final _callFfi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_routing_CalculateRouteCallback_call__RoutingError_ListOf_1sdk_1routing_1Route'));
...
int _sdkRoutingCalculateroutecallbackcallStatic(int _token, Pointer<Void> p0, Pointer<Void> p1) {
  
  try {
    (__lib.instanceCache[_token] as CalculateRouteCallback)(sdkRoutingRoutingerrorFromFfiNullable(p0)!, heresdkRoutingCommonBindingsListofSdkRoutingRouteFromFfiNullable(p1));
  } finally {
...
Pointer<Void> sdkRoutingCalculateroutecallbackToFfi(CalculateRouteCallback value) {
  final result = _sdkRoutingCalculateroutecallbackCreateProxy(
    __lib.cacheObject(value),
    __lib.LibraryContext.isolateId,
    __lib.uncacheObjectFfi,
    Pointer.fromFunction<Int64 Function(Uint64, Pointer<Void>, Pointer<Void>)>(_sdkRoutingCalculateroutecallbackcallStatic, __lib.unknownError)
  );
...
CalculateRouteCallback sdkRoutingCalculateroutecallbackFromFfi(Pointer<Void> handle) {
  final _impl = CalculateRouteCallback$Impl(_sdkRoutingCalculateroutecallbackCopyHandle(handle));
