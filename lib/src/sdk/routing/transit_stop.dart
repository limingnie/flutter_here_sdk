...
final _sdkRoutingTransitstopGetFielddurationInSeconds = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
...
Pointer<Void> sdkRoutingTransitstopToFfi(TransitStop value) {
  ...
  final _durationInSecondsHandle = intToFfiNullable(value.durationInSeconds);
  final _result = _sdkRoutingTransitstopCreateHandle(_departureHandle, _durationInSecondsHandle);
  sdkRoutingTransitdepartureReleaseFfiHandle(_departureHandle);
  intReleaseFfiHandleNullable(_durationInSecondsHandle);
  return _result;
}
...
TransitStop sdkRoutingTransitstopFromFfi(Pointer<Void> handle) {
  ...
  final _durationInSecondsHandle = _sdkRoutingTransitstopGetFielddurationInSeconds(handle);
  try {
    return TransitStop(
      sdkRoutingTransitdepartureFromFfi(_departureHandle), 
      intFromFfiNullable(_durationInSecondsHandle)!
    );
  } finally {
    sdkRoutingTransitdepartureReleaseFfiHandle(_departureHandle);
    intReleaseFfiHandleNullable(_durationInSecondsHandle);
